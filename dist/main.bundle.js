...
module.exports = "<app-customer-header></app-customer-header>\n<div class=\"container\">\n  <div class=\"row\">\n    <div class=\"col-md-6\">\n      <div class=\"card viewCustomerOrderStyle\">\n        <h1 class='text-center headerColor'>View Service Order</h1>\n        <hr>\n        <div *ngIf=\"orderInfo?.status =='pending'\">\n          <h3 class=\"text-center pendingColor\">STATUS: {{orderInfo?.status |uppercase}}</h3>\n        </div>\n        <div *ngIf=\"orderInfo?.status =='in progress'\">\n          <h3 class=\"text-center inProgressColor\">STATUS: {{orderInfo?.status |uppercase}}</h3>\n        </div>\n        <div *ngIf=\"orderInfo?.status =='waiting on parts'\">\n          <h3 class=\"text-center partsColor\">STATUS: {{orderInfo?.status |uppercase}}</h3>\n        </div>\n        <div *ngIf=\"orderInfo?.status =='waiting on customer'\">\n          <h2 class=\"text-center customerColor\">STATUS: {{orderInfo?.status |uppercase}}</h2>\n          <h3 class='text-center customerColor'>(Please select services below)</h3>\n        </div>\n        <div *ngIf=\"orderInfo?.status =='work complete'\">\n          <h3 class=\"text-center workCompletedColor\">STATUS: {{orderInfo?.status |uppercase}}</h3>\n        </div>\n        <div *ngIf=\"orderInfo?.status =='closed'\">\n          <h3 class=\"text-center closedColor\">STATUS: {{orderInfo?.status |uppercase}}</h3>\n        </div>\n        <hr>\n        <div *ngIf=\"recommendServiceArr.length > 0\">\n          <div class=\"text-center\">\n            <h4 class=\"pendingColor\"><u>Recommended Services</u></h4>\n            <div *ngFor=\"let service of orderInfo?.cusCarService\">\n              <h5 *ngIf=\"service.status == 'recommended'\" [ngClass]=\"{'clickedClass': isActive(service) }\" class=\"infoColor hoverItem\" (click)=\"selectService(service)\"><li><strong><u>{{service.type}} (${{service.price}})-</u></strong><p class=\"descStyle\">{{service.desc}}</p></li></h5>\n            </div>\n            <div *ngIf=\"approveMessage != ''\">\n              <div class=\"alert alert-success\"><p>{{approveMessage}}</p><button class=\"btn btn-primary approveSelectedBtn\" (click)=\"updateSelectedService('pending')\">Confirm Approval</button><button class=\"btn btn-danger\" (click)=\"approveMessage = ''\">Cancel</button></div>\n            </div>\n            <div *ngIf=\"declineMessage != ''\">\n              <div class=\"alert alert-danger\"><p>{{declineMessage}}</p><button class=\"btn btn-warning declineBtn\" (click)=\"updateSelectedService('declined')\">Decline Services</button><button class=\"btn btn-danger\" (click)=\"declineMessage = ''\">Cancel</button></div>\n            </div>\n            <div *ngIf=\"declineMessage == '' && approveMessage == ''\">\n              <button class=\"btn btn-primary approveSelectedBtn\" (click)=\"showApproveMsg()\">Approve Selected</button><button class=\"btn btn-warning\" (click)=\"showDeclineMsg()\">Decline Selected</button>\n            </div>\n          </div>\n          <hr>\n        </div>\n        <div class=\"text-center\">\n          <h3 class=\"headerColor\"><u>General Info</u></h3>\n          <h5>Make: {{orderInfo?.cusCarMake}}</h5>\n          <h5>Model: {{orderInfo?.cusCarModel}}</h5>\n          <h5>Year: {{orderInfo?.cusCarYear}}</h5>\n          <h5>Attendant: {{orderInfo?.cusAttendant}}</h5>\n          <h5>Location: {{orderInfo?.location}}</h5>\n          <h5>Created: {{orderInfo?.created_at | date:\"medium\"}}</h5>\n          <h5>Last Update: {{orderInfo?.updatedAt | date:\"medium\"}}</h5>\n        </div>\n        <hr>\n        <div class=\"text-center\">\n          <h3 class=\"headerColor\"><u>Current Services</u></h3>\n            <div *ngFor=\"let service of orderInfo?.cusCarService\" >\n              <h5 class=\"greenColor\"><li *ngIf=\"service.status == 'complete'\">{{service.status | uppercase}}: {{service.type}}</li></h5>\n              <h5 class=\"blueColor\"><li *ngIf=\"service.status == 'pending'\">{{service.status | uppercase}}: {{service.type}}</li></h5>\n            </div>\n        </div>\n        <div *ngIf=\"declinedServiceArr.length > 0\">\n          <hr>\n          <div class=\"text-center\">\n            <h3 class=\"headerColor\"><u>Declined Recommendations</u></h3>\n            <div *ngFor=\"let service of orderInfo?.cusCarService\" >\n              <h5 class=\"yellowColor\"><li *ngIf=\"service.status == 'declined'\">{{service.status | uppercase}}: {{service.type}}</li></h5>\n            </div>\n          </div>\n        </div>\n      </div>\n    </div>\n    <div class=\"col-md-6\">\n      <div class=\"card viewCustomerOrderStyle\">\n        <h1 class='text-center headerColor'>Cost Breakdown</h1>\n        <hr>\n        <div class=\"text-center\">\n          <h3 class=\"headerColor\"><u>Current Services</u></h3>\n            <div *ngFor=\"let service of orderInfo?.cusCarService\" >\n              <h5 class=\"greenColor\"><li *ngIf=\"service.status == 'complete' || service.status == 'pending'\">{{service.type}}- ${{service.price | number: \"1.2-2\"}}</li></h5>\n            </div>\n        </div>\n        <div *ngIf=\"selectedServicesArr.length > 0\">\n          <hr>\n          <div class=\"text-center\">\n            <h3 class=\"headerColor\"><u>Selected Services</u></h3>\n            <div *ngFor=\"let service of selectedServicesArr\">\n              <h5 class=\"infoColor\"><li>{{service.type}}- ${{service.price | number: \"1.2-2\"}}}</li></h5>\n            </div>\n          </div>\n        </div>\n        <hr>\n        <div class=\"text-center\">\n          <h3 class=\"headerColor\"><u>Tax</u></h3>\n          <h5 class=\"greenColor\">Current Services @ 7.5%: ${{taxCurrent | number: \"1.2-2\"}}</h5>\n          <div *ngIf=\"selectedServicesArr.length > 0\">\n            <h5 class=\"infoColor\">Current and Selected Services @ 7.5%: ${{taxWithSelected | number: \"1.2-2\"}}</h5>\n          </div>\n          <hr>\n          <h3 class=\"headerColor\"><u>Total</u></h3>\n          <h5 class=\"greenColor\">Current Services: ${{totalCost | number: \"1.2-2\"}}</h5>\n          <div *ngIf=\"selectedServicesArr.length > 0\">\n            <h5 class=\"infoColor\">Current and Selected Services: ${{totalCurrentAndSelectCost | number: \"1.2-2\"}}</h5>\n          </div>\n        </div>\n      </div>\n    </div>\n  </div>\n</div>\n"
